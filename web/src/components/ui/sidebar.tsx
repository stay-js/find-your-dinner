      ...
      <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>Oldálsáv</SheetTitle>
            <SheetDescription>Mobil oldalsáv megjelenítése</SheetDescription>
          </SheetHeader>
...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <button
      aria-label="Oldalsáv elrejtése/megjelenítése"
      className={cn(
      ...
      tabIndex={-1}
      title="Oldalsáv elrejtése/megjelenítése"
      {...props}
    />
  );
}
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">Oldalsáv elrejtése/megjelenítése</span>
    </Button>
  );
}
